...
class PhotoController:
    ...
    """
    Controls the camera of the NAO. Used to take photos

    Methods
    -------
    save_picture(resolution: int, format: str, name: str)
        Takes a picture and saves it in "/home/nao/pictures/"
    """

    def __init__(self, ip, port):
        # type: (str, int) -> PhotoController
    ...
    def save_picture(self, resolution, format, name):
        ...
        ----------
        resolution : int
            actual pixel count of the image, based on the following table
            |   8   |  40x30px  |
            ---------------------
            |   7   |  80x60px  |
            ---------------------
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--out", type=str, required=True, help="Name of the picture saved."
    )
